...
let
  ...
  sanitizersWorking = !stdenv.hostPlatform.isMusl && !stdenv.hostPlatform.isRiscV && (
...
in stdenv.mkDerivation {
  ...
  buildCommand = ''
    ...
    ${lib.optionalString (!stdenv.isDarwin) ''
      ...
      ${emulator} ./cc-static
      ${lib.optionalString (stdenv.cc.isGNU && (stdenv.hostPlatform.isx86 || stdenv.hostPlatform.isAarch64)
